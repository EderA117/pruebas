...
public class VentanaComic extends JFrame {
    ...
    public VentanaComic(String title) throws HeadlessException {
        ...
        txtTitulo = new JTextField(45);
        txtURLPortada = new JTextField(55);
        txtAutor = new JTextField(30);
        txtEditorial = new JTextField(30);
        txtAnioLanzamiento = new JTextField(7);
        txtNumPaginas = new JTextField(7);
        ...
        panel2.setBackground(new Color(146, 131, 250, 255));
        ...
        panel3.setBackground(new Color(208, 133, 101, 255));
        ...
        panel4.setBackground(new Color(250, 155, 192, 255));
    ...
    public JTextField getTxtEditar() {
        return txtEditar;
    }

    public void setTxtEditar(JTextField txtEditar) {
